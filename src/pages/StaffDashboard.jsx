/**
 * StaffDashboard.jsx — DV Finance
 * EXACT layout + REAL DATA from API (dashboard/staff)
 */

import { useEffect, useState } from 'react';
import { Row, Col, Card, Spin, Alert, Statistic, Progress, Typography, Grid, Table } from 'antd';
...
export default function StaffDashboard() {
  ...
  const { result: data, error } = useFetch(() => request.get({ entity: 'dashboard/staff' }));
    ...
    <DashboardLayout>
      ...
      >
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={8}>
            <Card>
              <Statistic title="Total Assigned" value={totalAssigned} prefix={<TeamOutlined />} />
            </Card>
          </Col>
        ...
        <Row gutter={[16, 16]} style={{ marginTop: 8 }}>
          ...
          <Col xs={24} md={6}>
            <Card>
              ...
              <Progress percent={efficiency} size="small" showInfo={false} strokeColor="#ff4d4f" />
            </Card>
          </Col>
        </Row>

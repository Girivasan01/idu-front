/**
 * pages/PerformanceSummary/index.jsx — DV Finance
            ...
            >
              <div style={{ textAlign: 'center', padding: isMobile ? '8px 0' : '16px 0' }}>
                ...
                <Typography.Text type="secondary" style={{ fontSize: isMobile ? 12 : 13 }}>
                  {translate(
                    'Efficiency is calculated as collected amount versus expected installments.'
                  )}
                </Typography.Text>
              </div>
            </Card>
                ...
                {breakdownItems.map((item) => (
                  <Col xs={12} key={item.title}>
                    ...
                    >
                      ...
                      <div
                        style={{ fontWeight: 700, fontSize: isMobile ? 20 : 24, color: item.color }}
                      >
                        {item.value}
                      </div>
                    </Card>
